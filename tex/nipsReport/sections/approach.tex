\section{Approach}
    ...
    \subsection{Implementation}
        ...
        \subsubsection{Object recognition}
            ...
            This algorithm follows a simple posterior update procedure given in \eqref{eq:posteriorUpdateGeneral} and \eqref{eq:posteriorUpdateComputation} which is efficiently computed using dynamic programming by caching the values given in \tabref{tab:dynamicProgramming}.

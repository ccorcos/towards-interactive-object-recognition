    ...
    \subsection{Implementation}
        ...
        \subsubsection{Object recognition}
            ...
            \subsubsection{Action selection}
                ...
                The next posterior is computed for each particle by \eqref{eq:fullPosteriorSimplified}. The posterior object probability distribution is computed by marginalizing all poses given in \eqref{eq:objectPosterior}.

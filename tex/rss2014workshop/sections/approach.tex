        ...
        \subsubsection{Interactive Object Recognition}
            ...
            \begin{figure}[h]
                ...
                \begin{tikzpicture}[scale=0.6, every node/.style={scale=0.6}]
					...
					\plate {} {(F)(P)(O)(pf)} {$\text{measurement model}$}

...
\vspace{-1ex}
	...
	One of our action selection experiment is represented by the decision tree in \figref{fig:tree}.    
 ...
 Of the four actions, staying and rotating result in similarly ambiguous poses resulting in an expected entropy of $0.7$. Flipping the book over, with and without rotating, lead to similarly unambiguous poses with an expected entropy of $0$. After flipping the book, the robot observes the cover of the book (\figref{fig:posteriors} bottom-left) and knows precisely what book it is observing (\figref{fig:posteriors} bottom-right).
